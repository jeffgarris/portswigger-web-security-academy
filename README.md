...
<summary>Server-side vulnerabilities</summary>

*Server-side vulnerabilities are weaknesses in backend systems that attackers can exploit to access data, bypass security, or disrupt services.*
...
| Lab | Status | Write-up |
| :---        |    :----:   |         :--- |
| Path traversal | ✔️ | [Path traversal](docs/path-traversal.md) |
| Access control |         |      |
-->
